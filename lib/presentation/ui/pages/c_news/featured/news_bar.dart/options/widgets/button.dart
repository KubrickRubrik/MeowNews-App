...
<<<<<<<< HEAD:lib/presentation/ui/pages/c_news/featured/news_bar/options/widgets/button.dart
========
      ),
      clipBehavior: Clip.hardEdge,
      child: Selector<NewsProvider, (StatusSection, StatusSection)>(
        ...
        child: const _ButtonGoSearch(),
>>>>>>>> master:lib/presentation/ui/pages/c_news/featured/news_bar.dart/options/widgets/button.dart
      ),
    );
  }
}
